...
class ScheduleViewSet(viewsets.GenericViewSet):
    ...
    def get_schedule_week(self, request):  # noqa
...
class ScheduleRetrieveOrDestroy(generics.GenericAPIView):
    ...
    def get_instance(self, request, *args, **kwargs):  # noqa
...
class ContentSlideDetailOrList(viewsets.ReadOnlyModelViewSet):
    queryset = models.ContentSlide.objects.all().order_by("-id")
    serializer_class = serializers.EventSerializer
    filterset_class = filters.EventFilter  # noqa
